return {
  ...
  config = function()
    ...
    -- Search operations (organized under <leader>s)
    ...
    -- Code/Diagnostics operations (organized under <leader>c)
    ...
    -- Default / key behavior restored (removed Telescope override)
    -- Use <leader>/ for Telescope fuzzy search in current buffer
