return {
  ...
  opts = {
    ...
    close_filetypes_on_save = { "checkhealth" , "help", "qf", "lspinfo", "null-ls-info", "toggleterm", "terminal", "lazy", "mason", "notify", "spectre_panel", "TelescopePrompt", "DressingSelect", "neo-tree" },
